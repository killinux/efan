...
<div class="pageContent">
    ...
    <div class="panelBar">
        <ul class="toolBar">
            <li><label style="float:left"><input type="checkbox" class="checkboxCtrl" group="app_add_id" />全选</label></li>
    ...
    <table class="table" width="100%" layoutH="110">
        ...
        <tbody>
            ...
            <tr>
            	...
            	<td><input type="checkbox" name="app_add_id" value="${item.id}"  /></td>
                <td><c:out value="${item.id	}" /></td>
                <td><c:out value="${item.name}" /></td>
                <td> <c:out value="${item.catagorys}" /> </td>
            </tr>
            </c:forEach>
        </tbody>
    </table>
